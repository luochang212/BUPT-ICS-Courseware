function [x_star,f_star,info_iter,xk_iter] = sd_q_exact(A,b,c,x0,eplison)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% run by  
% [x,f,info,xk]=sd_q_exact(2*[10,0;0,0.1],[0 0]',0,[1,10]',1e-6)
% [x,f,info,xk]=sd_q_exact(2*[1000,0;0,0.001],[0 0]',0,[1,10000]',1e-6)
% zigzag
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
while normg>eplison && it<max_it
    ...
    xk = x0 + alpha0*d0;     xk_iter =[xk_iter;xk'];
